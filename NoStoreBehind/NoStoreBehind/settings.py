"""
Django settings for NoStoreBehind project.
...
# dotenv installed but not taken
...
ROOT_URLCONF = 'NoStoreBehind.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [], #os.path.join(BASE_DIR, 'build') carpeta de templates de react
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'NoStoreBehind.wsgi.application'
...
# media/    dist/static
# Verify this structure to frontend integration
