    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='ecommerce.product')),
            ],
        ),
        migrations.CreateModel(
            name='ShoppingCart',
            fields=[
                ...
                ('orders', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='shopping_cart', to='ecommerce.orderrequest')),
            ],
        ),
        migrations.CreateModel(
            name='Shop',
        ...
        migrations.AddField(
            ...
            name='shop',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='images', to='ecommerce.shop'),
        ),
        migrations.AddField(
            model_name='product',
            name='shop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shopping_cart', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, serialize=False, to='ecommerce.shoppingcart')),
